...
bool LowVoltageFlag1 = 0; //Flag used to denote the fact that the battery voltage is too low, 0 = Ok, 1 = Low Voltage. 
bool LowVoltageFlag2 = 0; //Flag used to denote the fact that the battery voltage is too low, 0 = Ok, 1 = Low Voltage. 
